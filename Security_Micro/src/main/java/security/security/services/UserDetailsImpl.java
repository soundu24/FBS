...
public class UserDetailsImpl implements UserDetails {
	...
	public UserDetailsImpl(String id, String firstName, String lastname, String username, String email, String phoneNo,
	...
	public static UserDetailsImpl build(User user) {
		...
		return new UserDetailsImpl(user.getId(), user.getFirstName(), user.getLastName(), user.getUsername(),
				user.getEmail(), user.getPhoneNo(), user.getGender(), user.getPassword(), authorities);
	}
